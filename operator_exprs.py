...
def Operate(optr, *args):
    ...
    if optr == '+':
        if isinstance(args[0], int) and isinstance(args[1], int):
            ...
            raise GOIFError("Operands must both be integers.")
    # subtraction
    elif optr == '-':
        if len(args) == 1:
            ...
            raise GOIFError("Operands must be integers.")
    # multiplication
    elif optr == '*':
        if isinstance(args[0], int) and isinstance(args[1], int):
            return args[0] * args[1]
    ...
    # equality
        ...
        if isinstance(args[0], str) and isinstance(args[1], str):
            ...
            raise GOIFError("Operands must both be integers or must both be strings.")
    # less than or equal to
    elif optr == '!=':
        if isinstance(args[0], int) and isinstance(args[1], int):
            return args[0] != args[1]
    ...
    # integer division
        ...
        if isinstance(args[0], int) and isinstance(args[1], int):
            ...
            raise GOIFError("Operand must both be integers.")
    # modulus
    elif optr == '\\':
        if isinstance(args[0], int) and isinstance(args[1], int):
            if args[1] == 0:
    ...
    # boolean not
        ...
        if isinstance(args[0], bool):
            ...
            raise GOIFError("Operand must be a boolean.")
    # boolean and
    elif optr == '&':
        if isinstance(args[0], bool) and isinstance(args[1], bool):
            return args[0] and args[1]
        else:
            raise GOIFError("Operands must both be booleans.")
    elif optr == '|':
        if isinstance(args[0], bool) and isinstance(args[1], bool):
    ...
    # indexing
        ...
        if isinstance(args[0], str) and isinstance(args[1], int):
            ...
            raise GOIFError("First operand must be a string and second operand must be an integer.")
    # concatenate
    elif optr == '^':
        if isinstance(args[0], str) and isinstance(args[1], str):
            return args[0] + args[1]
        else:
            raise GOIFError("Operands must both be strings.")
    # ternary operator
    elif optr == '?':
        if isinstance(args[0], bool):
            if args[0]:
            ...
            raise GOIFError("First operand must be bool.")
